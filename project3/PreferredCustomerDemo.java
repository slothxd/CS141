public class PreferredCustomerDemo
{
	...
	PreferredCustomer myCustomer =new PreferredCustomer("Julie James", "123 Main Street", 
"555-1212", "147-A049", true, 1750.00);
	...
	showDiscountInfo(myCustomer);
	}

	private static void showDiscountInfo(DiscountTag item)
 	{
	System.out.printf("This customer's discount level is: $%,.2f\n",item.getDiscountLevel());
	}
}
